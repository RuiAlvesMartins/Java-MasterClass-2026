...
public class Drink {
    ...
    protected Drink(String type, double basePrice) {
        this.type = type;
        this.size = "M";
    ...
    public static Drink getDrink(String type, double price) {

        return new Drink(type, price);

    }

    public static Drink getDrink() {

        return new Drink("Classic Coke", 1D);
